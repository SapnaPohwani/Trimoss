        ...
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4 mb-8">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 via-teal-500 to-yellow-500 rounded-lg flex items-center justify-center relative overflow-hidden">
                {/* Mosaic T Logo */}
                ...
                <span className="text-white text-2xl font-bold relative z-10">T</span>
              </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">Solutions</a></li>
              <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">Pricing</a></li>
              <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">Team</a></li>
              <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">Career</a></li>
            </ul>
          </div>

          {/* Documentation Links */}
          <div>
            <h4 className="text-lg font-semibold text-gray-900 mb-6">Documentation</h4>
            <ul className="space-y-4">
              <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">Help Centre</a></li>
              <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">Contact</a></li>
              <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">FAQ</a></li>
          ...
          {/* Social Links */}
          <div>
            <h4 className="text-lg font-semibold text-gray-900 mb-6">Social</h4>
            <ul className="space-y-4">
              <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">Facebook</a></li>
              <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">Instagram</a></li>
              <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">Youtube</a></li>
