      ...
      <div className="w-full lg:w-[454px] xl:w-[28rem] h-10/12 rounded-2xl m-2 bg-white flex items-center justify-center p-4 lg:p-20">
        <div className="w-full max-w-sm">
          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            <button onClick={()=>navigate("/login")} className="w-full bg-gray-200 text-gray-900 py-3 rounded-full  font-medium hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 transition-all duration-200 transform hover:scale-[1.02]">
              Log in
            </button>
          </div>
        </div>
